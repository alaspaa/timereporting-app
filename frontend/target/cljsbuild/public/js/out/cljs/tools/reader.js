...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__40880 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__40880,ch);
...
if(("\\" === ch__$1)){
var ch_40881__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_40881__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_40881__$2);
} else {
}

var G__40882 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__40882;
continue;
}
}
...
var vec__40890 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__40890,(0),null);
var start_column = cljs.core.nth.call(null,vec__40890,(1),null);
...
var G__40893 = cljs.core.conj_BANG_.call(null,a,form);
a = G__40893;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__40894 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__40895 = true;
(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__40895);

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__40894);
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__40896 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__40896,(0),null);
var start_column = cljs.core.nth.call(null,vec__40896,(1),null);
...
var vec__40899 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__40899,(0),null);
var end_column = cljs.core.nth.call(null,vec__40899,(1),null);
...
var vec__40902 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__40902,(0),null);
var start_column = cljs.core.nth.call(null,vec__40902,(1),null);
...
var vec__40905 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__40905,(0),null);
var end_column = cljs.core.nth.call(null,vec__40905,(1),null);
...
var vec__40908 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__40908,(0),null);
var start_column = cljs.core.nth.call(null,vec__40908,(1),null);
...
var vec__40911 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__40911,(0),null);
var end_column = cljs.core.nth.call(null,vec__40911,(1),null);
...
var sb = (function (){var G__40914 = (new goog.string.StringBuffer());
G__40914.append(initch);
...
var G__40916 = (function (){var G__40915 = sb;
G__40915.append(ch);
...
switch (G__40920) {
case "\\":
var G__40924 = (function (){var G__40921 = sb;
G__40921.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__40921;
})();
var G__40925 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__40924;
ch = G__40925;
continue;
...
break;
default:
var G__40926 = (function (){var G__40922 = sb;
G__40922.append(ch);

return G__40922;
})();
var G__40927 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__40926;
ch = G__40927;
continue;
...
var vec__40928 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__40928,(0),null);
var end_column = cljs.core.nth.call(null,vec__40928,(1),null);
...
var vec__40931 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__40931,(0),null);
var column = cljs.core.nth.call(null,vec__40931,(1),null);
...
var vec__40936 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__40936,(0),null);
var column = cljs.core.nth.call(null,vec__40936,(1),null);
...
var vec__40941 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__40941,(0),null);
var column = cljs.core.nth.call(null,vec__40941,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__40946 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__40946,(0),null);
var start_column = cljs.core.nth.call(null,vec__40946,(1),null);
...
var vec__40949 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__40949,(0),null);
var end_column = cljs.core.nth.call(null,vec__40949,(1),null);
...
var G__40952 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__40952,true,null,opts,pending_forms);
...
var G__40953 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__40953)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__40953)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__40953)){
...
var _STAR_suppress_read_STAR__orig_val__40954 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__40955 = true;
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__40955);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__40954);
}});
...
var G__40956 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__40956,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__40956,rdr,first_line);
...
var G__40960 = matched;
var G__40961 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__40960;
finished = G__40961;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__40962 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__40963 = (function (){var or__4185__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
...
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__40963);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__40962);
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__40964 = cljs.tools.reader.arg_env;
var arg_env_temp_val__40965 = cljs.core.sorted_map.call(null);
(cljs.tools.reader.arg_env = arg_env_temp_val__40965);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__40966 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__40966,"(");
...
var G__40967 = (i + (1));
var G__40968 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4185__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
...
}finally {(cljs.tools.reader.arg_env = arg_env_orig_val__40964);
}});
/**
...
var ch = temp__5733__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__40969 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__40969);
...
var G__40970 = cljs.core.next.call(null,s__$1);
var G__40971 = ret;
s__$1 = G__40970;
r = G__40971;
continue;
...
var G__40972 = cljs.core.next.call(null,s);
var G__40973 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__40972;
key_vals = G__40973;
continue;
} else {
...
var gensym_env_orig_val__40978 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__40979 = cljs.core.PersistentArrayMap.EMPTY;
(cljs.tools.reader.gensym_env = gensym_env_temp_val__40979);
...
}finally {(cljs.tools.reader.gensym_env = gensym_env_orig_val__40978);
}});
...
var temp__5733__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__40980 = token;
var G__40980__$1 = (((G__40980 == null))?null:cljs.core.subs.call(null,G__40980,(1)));
var G__40980__$2 = (((G__40980__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__40980__$1));
var G__40980__$3 = (((G__40980__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__40980__$2));
var G__40980__$4 = (((G__40980__$3 == null))?null:cljs.core.symbol.call(null,G__40980__$3));
if((G__40980__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__40980__$4);
}
})():(function (){var G__40981 = token;
var G__40981__$1 = (((G__40981 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__40981));
if((G__40981__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__40981__$1);
}
})()
));
if(cljs.core.truth_(temp__5733__auto__)){
...
(cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__40992,reader){
...
var eof = cljs.core.get.call(null,map__40993__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
//# sourceMappingURL=reader.js.map?rel=1580050198831

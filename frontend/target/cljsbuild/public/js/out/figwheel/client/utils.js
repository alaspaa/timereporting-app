...
return (new CustomEvent(event_name,(function (){var obj47313 = ({"detail":data});
return obj47313;
})()));
} else {
...
var f = (function (){var pred__47320 = cljs.core._EQ_;
var expr__47321 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__47320.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__47321))){
return (function (p1__47314_SHARP_){
return console.warn(p1__47314_SHARP_);
});
} else {
if(cljs.core.truth_(pred__47320.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__47321))){
return (function (p1__47315_SHARP_){
return console.debug(p1__47315_SHARP_);
});
} else {
if(cljs.core.truth_(pred__47320.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__47321))){
return (function (p1__47316_SHARP_){
return console.error(p1__47316_SHARP_);
});
} else {
return (function (p1__47317_SHARP_){
return console.log(p1__47317_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__47324){
var map__47325 = p__47324;
var map__47325__$1 = (((((!((map__47325 == null))))?(((((map__47325.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__47325.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__47325):map__47325);
var opts = map__47325__$1;
var eval_fn = cljs.core.get.call(null,map__47325__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__47327_SHARP_){
return new_def.callback(p1__47327_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__47328){
var vec__47329 = p__47328;
var ky = cljs.core.nth.call(null,vec__47329,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1579787427518

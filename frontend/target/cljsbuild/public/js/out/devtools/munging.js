...
var o28205 = temp__5733__auto__;
var temp__5733__auto____$1 = (o28205["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o28206 = temp__5733__auto____$1;
return (o28206["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27093__auto__ = f;
return (o__27093__auto__["toString"]).call(o__27093__auto__);
} else {
return "";
}
}catch (e28207){var _ = e28207;
return "";
}});
...
try{var o__27093__auto___28209 = t;
(o__27093__auto___28209["cljs$lang$ctorPrWriter"]).call(o__27093__auto___28209,t,writer);
}catch (e28208){var __28210 = e28208;
}
...
var char_code = (function (){var o__27093__auto__ = (new String(char$));
return (o__27093__auto__["charCodeAt"]).call(o__27093__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27093__auto__ = String;
return (o__27093__auto__["fromCharCode"]).call(o__27093__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__28211 = num_code;
switch (G__28211) {
case (1):
return (185);
...
var o__27093__auto__ = String;
return (o__27093__auto__["fromCharCode"]).call(o__27093__auto__,superscript_code);
});
/**
...
}catch (e28213){var _e__27100__auto__ = e28213;
return false;
}})())){
...
var vec__28214 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__28214,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o28217 = temp__5733__auto__;
var temp__5733__auto____$1 = (o28217["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o28218 = temp__5733__auto____$1;
return (o28218["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4789__auto___28225 = arguments.length;
var i__4790__auto___28226 = (0);
while(true){
if((i__4790__auto___28226 < len__4789__auto___28225)){
args__4795__auto__.push((arguments[i__4790__auto___28226]));

var G__28227 = (i__4790__auto___28226 + (1));
i__4790__auto___28226 = G__28227;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__28221){
var vec__28222 = p__28221;
var ns_detector = cljs.core.nth.call(null,vec__28222,(0),null);
...
var G__28228 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__28229 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__28228;
remaining_tokens = G__28229;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq28219){
var G__28220 = cljs.core.first.call(null,seq28219);
var seq28219__$1 = cljs.core.next.call(null,seq28219);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28220,seq28219__$1);
}));
...
var vec__28233 = cljs.core.split_with.call(null,(function (p1__28232_SHARP_){
return cljs.core.not_EQ_.call(null,p1__28232_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__28233,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__28233,(1),null);
...
var vec__28239 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__28239,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__28239,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__28242 = cljs.core.rest.call(null,remaining_tokens);
var G__28243 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__28242;
name_tokens = G__28243;
continue;
} else {
...
var vec__28246 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__28246,(0),null);
var arity = cljs.core.nth.call(null,vec__28246,(1),null);
var vec__28249 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__28249,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__28249,(1),null);
var vec__28252 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__28252,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__28252,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__28252,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__28252,(3),null);
...
var vec__28258 = result;
var munged_ns = cljs.core.nth.call(null,vec__28258,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__28258,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__28258,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__28258,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__28258,(4),null);
var arity = cljs.core.nth.call(null,vec__28258,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__28262 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__28262,(0),null);
var args = cljs.core.nth.call(null,vec__28262,(1),null);
var vec__28265 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__28265,(0),null);
var name = cljs.core.nth.call(null,vec__28265,(1),null);
...
var G__28268 = (arity + (1));
var G__28269 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__28270){
var vec__28271 = p__28270;
var arity = cljs.core.nth.call(null,vec__28271,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__28271,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__28274_SHARP_){
return cljs.core.get.call(null,arities,p1__28274_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__28275_SHARP_){
return cljs.core.drop.call(null,(2),p1__28275_SHARP_);
}),sorted_infos);
...
var args__4795__auto__ = [];
var len__4789__auto___28282 = arguments.length;
var i__4790__auto___28283 = (0);
while(true){
if((i__4790__auto___28283 < len__4789__auto___28282)){
args__4795__auto__.push((arguments[i__4790__auto___28283]));

var G__28284 = (i__4790__auto___28283 + (1));
i__4790__auto___28283 = G__28284;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__28278){
var vec__28279 = p__28278;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__28279,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq28276){
var G__28277 = cljs.core.first.call(null,seq28276);
var seq28276__$1 = cljs.core.next.call(null,seq28276);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28277,seq28276__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__28287__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__28287__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__28287__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__28287__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__28288 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__28288,(0),null);
var fn_name = cljs.core.nth.call(null,vec__28288,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__28288,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__28288,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__28288,(4),null);
var arity = cljs.core.nth.call(null,vec__28288,(5),null);
...
var o__27093__auto__ = f;
return (o__27093__auto__["getBasis"]).call(o__27093__auto__);
});
/**
...
}catch (e28292){var _e__27100__auto__ = e28292;
...
var G__28293 = (obj[cljs.core.first.call(null,path)]);
var G__28294 = cljs.core.rest.call(null,path);
obj = G__28293;
path = G__28294;
continue;
} else {
...
var _STAR_ = (function (accum,p__28295){
var vec__28296 = p__28295;
var bit = cljs.core.nth.call(null,vec__28296,(0),null);
var protocol = cljs.core.nth.call(null,vec__28296,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__28299){
var vec__28300 = p__28299;
var ns = cljs.core.nth.call(null,vec__28300,(0),null);
var name = cljs.core.nth.call(null,vec__28300,(1),null);
var selector = cljs.core.nth.call(null,vec__28300,(2),null);
...
var post_process = (function (p__28304){
var vec__28305 = p__28304;
var munged_name = cljs.core.nth.call(null,vec__28305,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__28305,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__28303_SHARP_){
return (obj[cljs.core.first.call(null,p1__28303_SHARP_)]);
}),sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1580050084945

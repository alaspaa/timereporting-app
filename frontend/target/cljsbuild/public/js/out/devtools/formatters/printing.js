...
var len__4789__auto___28385 = arguments.length;
var i__4790__auto___28386 = (0);
while(true){
if((i__4790__auto___28386 < len__4789__auto___28385)){
args__4795__auto__.push((arguments[i__4790__auto___28386]));

var G__28387 = (i__4790__auto___28386 + (1));
i__4790__auto___28386 = G__28387;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq28382){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28383,G__28384,seq28382__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__28388_SHARP_){
return (!((cljs.core.meta.call(null,p1__28388_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.call(null,map__28389__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e28393){var _e__27100__auto__ = e28393;
return false;
}})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
}catch (e28395){var _e__27100__auto__ = e28395;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__28397 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__28398 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__28398);

try{var map__28399 = opts;
...
var markup_db = cljs.core.get.call(null,map__28399__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__28397);
}});
...
var temp__5733__auto___28404 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5733__auto___28404)){
var managed_print_level_28405 = temp__5733__auto___28404;
var _STAR_print_level_STAR__orig_val__28402_28406 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__28403_28407 = managed_print_level_28405;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__28403_28407);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__28401_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__28401_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__28402_28406);
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1580050090176
